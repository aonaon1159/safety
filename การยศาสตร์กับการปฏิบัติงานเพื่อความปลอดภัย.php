...
<?php 
    $id_training = 453;//การยศาสตร์กับการปฏิบัติงานเพื่อความปลอดภัย
...
<main id="main-container" class="main-container">
    ...
    <section class="padding_bottom">
        <div class="container p-t-160 p-b-80 no_br">
            <h2 class="text-center"><b>การยศาสตร์กับการปฏิบัติงานเพื่อความปลอดภัย</b></h2>
                ...
                <div class="col-md-6 col-12 align-self-center mb-3">
                    <div class="row">
                        <div class="col-lg-9 col-md-11 col-12 m-auto">
                            <h6>
                                รายงานของสำนักงานสถิติแรงงาน (Bureau of Labor Statistics) แห่งสหรัฐอเมริกา เมื่อ ค.ศ.
                                ๑๙๙๒ ระบุว่า การเจ็บป่วย เนื่องจากการทำงาน ที่เพิ่มขึ้นระหว่าง ค.ศ. ๑๙๘๙ - ค.ศ. ๑๙๙๐
                                นั้น ร้อยละ ๘๐ ได้แก่ ความพิการ เนื่องมาจากการบาดเจ็บเรื้อรัง (cumulative trauma
                                disorders) ซึ่งมีตั้งแต่ อาการเจ็บที่กล้ามเนื้อ ไปจนถึงความพิการ เช่น
                                การสูญเสียการได้ยิน เนื่องจาก การทำงานในสถานที่ที่มีเสียงดังมากเกินไป
                                อาการบาดเจ็บที่กล้ามเนื้ออาจเกิดขึ้น จากการเคลื่อนไหวซ้ำๆ ต่อเนื่องเป็นเวลานาน เช่น
                                อาการเจ็บข้อมือ เนื่องจากการพิมพ์ดีด หรือการทำงานอยู่ในท่าใดท่าหนึ่ง เป็นเวลานานๆ เช่น
                                ต้องก้มหรือยื่นแขน เป็นเวลานาน ซึ่งการเคลื่อนไหวซ้ำๆ หรือทำงานในท่าใดท่าหนึ่ง
                                เป็นเวลานาน สามารถก่อให้เกิดการอักเสบ การบวมของเอ็น ที่ข้อต่อ หรือเกิดการบาดเจ็บได้
                            </h6>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-md-6 col-12 align-self-center mb-3">
                    <div class="row">
                        <div class="col-lg-9 col-md-11 col-12 m-auto">
                            <h6>
                                นอกจากนี้ การอยู่ในสภาพแวดล้อมที่ไม่เหมาะสม เป็นเวลานาน หรือบ่อยครั้ง
                                ก็ก่อให้เกิดการเจ็บป่วยได้เช่นกัน เช่น การยกของที่มีน้ำหนักมากบ่อยครั้ง
                                อาจทำให้เกิดอาการปวดหลัง หรือการเจ็บป่วย ที่บริเวณหลัง
                                การอยู่ในสิ่งแวดล้อมหรือสถานที่ที่มีเสียงดัง เกินกำหนด อาจทำให้สูญเสียการได้ยิน
                                หรือถ้าอยู่ในสถานที่ ที่มีแสงน้อยเกินไป อาจทำให้เกิดอาการปวดหัวและล้าที่กล้ามเนื้อตาได้
                                ดังนั้น นักการยศาสตร์จึงออกแบบสถานที่ทำงาน ให้มีการเคลื่อนไหว
                                ประเภทที่ก่อให้เกิดความเจ็บป่วยได้น้อยที่สุด และสร้างสิ่งแวดล้อมให้เหมาะสม
                                ต่อการปฏิบัติงาน โดยคาดว่า สิ่งแวดล้อมที่เหมาะสมในการทำงานนั้น จะก่อให้เกิดความสะดวกสบาย
                                ปราศจากความล้าทั้งด้านร่างกายและจิตใจ ซึ่งความล้าเหล่านี้
                                เป็นสาเหตุหนึ่งของการเกิดความผิดพลาด และอุบัติเหตุต่างๆ
                            </h6>
                        </div>
                    </div>
                </div>
    ...
    <section class="white-bg padding_top" id="table_course">
        <div class="container p-b-80 p-t-80">
            <h2 class="text-center"><b class="head_nav">การยศาสตร์กับการปฏิบัติงานเพื่อความปลอดภัย</b></h2>
            <hr class="hr_green mx-auto hr_fix_width">
            <h5 class="text-center">ท่านสามารถค้นหาหลักสูตรการยศาสตร์กับการปฏิบัติงานเพื่อความปลอดภัย
            </h5>
            <br>
            <div class="row">
                <div class="col-md-12">
                    <div class="tab" role="tabpanel">
                        <ul class="nav nav-tabs" role="tablist">
                            <li style="width: 50%;" class="text-center" role="presentation"><a data-id_branch="46"
                                    data-id_training="454" href="#tab1" class="active" role="tab" data-toggle="tab"></i>
                                    <h5>ออนไลน์</h5>
                                </a></li>
            ...
            <div class="col-lg-6 col-md-12 col-12 align-self-center black-bg p-t-80 p-b-80">
                <div class="row mx-4">
                    <div class="col-lg-12 col-md-11 col-12 m-auto">
                        ...
                        2)
                        ผู้เข้ารับการอบรมสามารถนำความรู้หลักการของกายศาสตร์ไปประยุกต์ใช้ปรับปรุงสถานที่และสภาพแวดล้อมในการทำงาน<br><br>

                        หัวข้อการอบรม<br>
                        1) ความหมายและความสำคัญของการยศาสตร์ (Ergonomics)<br>
                        2) องค์ประกอบของการยศาสตร์<br>
                        3) การประยุกต์ใช้หลักการยศาสตร์กับการปฏิบัติงานเพื่อความปลอดภัย<br>
                        3.1 หลักการยศาสตร์ในสายงานการผลิต<br>
                        3.2 หลักการยศาสตร์ในสำนักงาน<br>
                        4) การปรับปรุงสถานที่และสภาพแวดล้อมการปฏิบัติงานตามหลักการยศาสตร์<br>
            ...
            <div class="row">
                <div class="col-lg-6 align-self-center text-center mb-3">
                    <img title="" class="box_shadow img-fluid"
                        src="<?php echo $base_url;?>/img/bg/การยศาสตร์เพื่อเพิ่มผลผลิตและอาชีวอนามัยความปลอดภัย-เซฟตี้อินไทย-safetyinthai.jpg"
                        alt="">
                </div>
                <div class="col-lg-6 px-5 align-self-center mb-3">
                    <h2 class="text-center"><b>การยศาสตร์เพื่อเพิ่มผลผลิตและอาชีวอนามัยความปลอดภัย</b></br></h2>
                    <hr class="hr_green mx-auto hr_fix_width">
                    ...
                    <div class="row">
                        <div class="col-md-6 col-8">
                            <a href="การยศาสตร์เพื่อเพิ่มผลผลิตและอาชีวอนามัยความปลอดภัย">
                                <button
                                    class="btn btn-block btn--medium btn--radius btn--black btn--black-hover-green font--light text-uppercase">
                                    รายละเอียดเพิ่มเติม
                                </button>
                    ...
                    <ul>
                        <li><i class="fas fa-check-circle"></i>
                            ...
                            ความเข้าใจในหลักการด้านการยศาสตร์กับการทำงานเพื่อเพิ่มผลผลิตและอาชีวอนามัยความปลอดภัย
                        </li>
                        <li><i class="fas fa-check-circle"></i>
                            ผู้เข้ารับการอบรมสามารถนำความรู้หลักการของกายศาสตร์ไปประยุกต์ใช้ปรับปรุงสถานที่และสภาพแวดล้อม
                            ในการทำงาน</li>
                    </ul>
                </div>
            </div>
