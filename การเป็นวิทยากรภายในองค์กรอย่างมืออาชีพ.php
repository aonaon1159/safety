...
<?php 
    $id_training = 451;//การเป็นวิทยากรภายในองค์กรอย่างมืออาชีพ
...
<main id="main-container" class="main-container">
    ...
    <section class="padding_bottom">
        <div class="container p-t-160 p-b-80 no_br">
            <h2 class="text-center"><b>การเป็นวิทยากรภายในองค์กรอย่างมืออาชีพ</b></h2>
            ...
            <div class="row">
                <div class="col-md-6 col-12 mb-3 text-center">
                    <img style="max-width: 75%;" class="box_shadow"
                        src="<?php echo $base_url;?>/img/template_gallery/gallery_forklift2 (14).jpg" alt="">
                </div>
    ...
    <section class="white-bg padding_top" id="table_course">
        <div class="container p-b-80 p-t-80">
            <h2 class="text-center"><b class="head_nav">การเป็นวิทยากรภายในองค์กรอย่างมืออาชีพ</b></h2>
            <hr class="hr_green mx-auto hr_fix_width">
            <h5 class="text-center">ท่านสามารถค้นหาหลักสูตรการเป็นวิทยากรภายในองค์กรอย่างมืออาชีพ
            </h5>
            <br>
            <div class="row">
                <div class="col-md-12">
                    <div class="tab" role="tabpanel">
                        <ul class="nav nav-tabs" role="tablist">
                            <li style="width: 50%;" class="text-center" role="presentation"><a data-id_branch="46"
                                    data-id_training="452" href="#tab1" class="active" role="tab" data-toggle="tab"></i>
                                    <h5>ออนไลน์</h5>
                                </a></li>
            ...
            <div class="col-lg-6 col-md-12 col-12 align-self-center black-bg p-t-80 p-b-80">
                <div class="row mx-4">
                    <div class="col-lg-12 col-md-11 col-12 m-auto">
                        ...
                        <hr class="hr_green mx-auto hr_fix_width">
                        การสร้างวิทยากรภายในองค์กรเป็นสิ่งสําคัญที่แต่ละองค์กรจะต้องสร้างขึ้น เพราะวิทยากรภายใน
                        เป็นการสร้างผู้เชี่ยวชาญ และสามารถถ่ายทอดประสบการณ์ให้กับบุคลากร เช่น
                        การปฏิบัติงานภายในองค์กรซึ่ง วิทยากรภายในจะวัฒนธรรม ระบบงาน และทราบถึงปัญหาและเหตุปัจจัยต่าง ๆ
                        เป็นอย่างดี วิทยากรภายในจึง สามารถจัดการเนื้อหา ในการอบรมได้ตรงตามเป้าหมาย
                        รวมทั้งการสร้างวิทยากรภายในสามารถลดค่าใช้จ่ายใน การจัดการอบรม
                        แทนการสรรหาวิทยากรภายนอกเพื่อเข้ามาอบรม หลักสูตรวิทยากรภายในด้านความปลอดภัย
                        เป็นหลักสูตรส่งเสริมความรู้ ทักษะ ที่สําคัญในการเป็นวิทยากร ได้อย่างมีประสิทภาพ<br><br>
                        วัตถุประสงค์<br>
                        1. ผู้เข้ารับการอบรมได้รับความรู้ ความเข้าใจในการเป็นวิทยากรภายในด้านความปลอดภัย<br>
                        2. ผู้เข้ารับการอบรมสามารถนําความรู้ไปประยุกต์ใช้ต่อบทบาทการเป็นวิทยากรภายในด้าน
                        ความปลอดภัย<br><br>
                        ผลที่คาดว่าจะได้รับ<br>
                        1. ผู้อบรมสามารถปฏิบัติงานได้ถูกต้องตามหลักการ และเทคนิคการวิทยากร<br>
                        2. ผู้อบรมสามารถนําความรู้ไปใช้ในการบริหาร จัดการด้านการออกแบบ และการจัดการเรียนรู้
                        ด้านความปลอดภัยได้ถูกต้องสอดคล้องกับกฎหมาย ระเบียบวิทยากรภายในด้านความปลอดภัย<br><br>
                        รูปแบบการฝึกอบรม<br>
