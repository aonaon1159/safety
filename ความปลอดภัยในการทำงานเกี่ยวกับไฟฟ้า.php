...
<?php 
    $id_training = 499;//ความปลอดภัยในการทำงานเกี่ยวกับไฟฟ้าและการช่วยเหลือผู้ประสบอันตรายจากไฟฟ้า
...
<main id="main-container" class="main-container">
    ...
    <section class="padding_bottom">
        <div class="container p-t-160 p-b-80 no_br">
            <h2 class="text-center"><b>ความปลอดภัยในการทำงานเกี่ยวกับไฟฟ้าและการช่วยเหลือผู้ประสบอันตรายจากไฟฟ้า</b>
            </h2>
                ...
                <div class="col-md-6 col-12 align-self-center mb-3">
                    <div class="row">
                        <div class="col-lg-9 col-md-11 col-12 m-auto">
                            <h6>
                                ตามกฎกระทรวงแรงงาน พ.ศ. 2558 กำหนดมาตรฐานในการบริหาร จัดการ และดำเนินการด้านความปลอดภัย
                                อาชีวอนามัย และสภาพแวดล้อมในการทำงานเกี่ยวกับไฟฟ้า หมวด 1 ข้อ 4
                                ให้นายจ้างจัดให้มีการฝึกอบรมให้ลูกจ้างปฏิบัติงานที่เกี่ยวกับไฟฟ้าให้มีความรู้ความเข้าใจ
                                และทักษะที่จำเป็นในการทำงานอย่างปลอดภัยตามหน้าที่ที่ได้รับมอบหมาย
                                โดยการอบรมเนื้อหาตรงกับประกาศกรมสวัสดิการคุ้มครองแรงงาน เรื่อง หลักเกณฑ์ วิธีการ
                            </h6>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-md-6 col-12 align-self-center mb-3">
                    <div class="row">
                        <div class="col-lg-9 col-md-11 col-12 m-auto">
                            <h6>
                                เงื่อนไขการฝึกอบรมความปลอดภัยในการทำงานเกี่ยวกับไฟฟ้าสำหรับลูกจ้างซึ่งปฏิบัติงานเกี่ยวกับไฟฟ้า
                                หมวด 1 ข้อ 2 และ หมวด 2 ข้อ 3
                                ความสำคัญของความปลอดภัยในการทำงานเกี่ยวกับไฟฟ้ากับการปฏิบัติให้สอดคล้องกับข้อปฏิบัติทางกฎหมายเป็นสิ่งสำคัญในการรักษาความปลอดภัยของชีวิตและทรัพย์สิน
                                ซึ่งเป็นสิ่งที่ต้องคำนึงเรื่องการทำงานคือ ความปลอดภัยต้องมาเป็นอันดับแรก
                            </h6>
                        </div>
                    </div>
                </div>
    ...
    <section class="white-bg padding_top" id="table_course">
        <div class="container p-b-80 p-t-80">
            <h2 class="text-center"><b
                    class="head_nav">ความปลอดภัยในการทำงานเกี่ยวกับไฟฟ้า<br>และการช่วยเหลือผู้ประสบอันตรายจากไฟฟ้า</b>
            </h2>
            <hr class="hr_green mx-auto hr_fix_width">
            <h5 class="text-center">
                ท่านสามารถค้นหาหลักสูตรความปลอดภัยในการทำงานเกี่ยวกับไฟฟ้าและการช่วยเหลือผู้ประสบอันตรายจากไฟฟ้า
            </h5>
            <br>
            <div class="row">
                <div class="col-md-12">
                    <div class="tab" role="tabpanel">
                        <ul class="nav nav-tabs" role="tablist">
                            <li style="width: 50%;" class="text-center" role="presentation"><a data-id_branch="46"
                                    data-id_training="499" href="#tab1" class="active" role="tab" data-toggle="tab"></i>
                                    <h5>ออนไลน์</h5>
                                </a></li>
            ...
            <div class="col-lg-6 col-md-12 col-12 align-self-center black-bg p-t-80 p-b-80">
                <div class="row mx-4">
                    <div class="col-lg-12 col-md-11 col-12 m-auto">
                        ...
                        หมวด 1 ข้อ 2 และ หมวด 2 ข้อ 3
                        ความสำคัญของความปลอดภัยในการทำงานเกี่ยวกับไฟฟ้ากับการปฏิบัติให้สอดคล้องกับข้อปฏิบัติทางกฎหมายเป็นสิ่งสำคัญในการรักษาความปลอดภัยของชีวิตและทรัพย์สิน
                        ซึ่งเป็นสิ่งที่ต้องคำนึงเรื่องการทำงานคือ ความปลอดภัยต้องมาเป็นอันดับแรก<br><br>
                        วัตถุประสงค์<br>
                        1)เพื่อให้ผู้เข้ารับการอบรมมีความรู้ในการปฏิบัติงานเกี่ยวกับไฟฟ้าได้อย่างปลอดภัยตามที่กฎหมายกำหนด<br>
                        2)เพื่อให้ผู้เข้าอบรมรู้อันตรายจากไฟฟ้าและหลักการป้องกันอันตรายเกี่ยวกับไฟฟ้า<br>
                        3)เพื่อให้ผู้เข้ารับการอบรมมีความรู้และได้ฝึกปฏิบัติการปฐมพยาบาลได้อย่างปลอดภัยทั้งผู้ประสบอันตรายและผู้ช่วยเหลือ<br><br>
                        เนื้อหาหลักสูตร<br>
                        1)กฎหมายความปลอดภัยในการทำงานเกี่ยวกับไฟฟ้าและความรู้พื้นฐานเกี่ยวกับไฟฟ้าสาเหตุและการป้องกันอันตรายจากไฟฟ้าและอุปกรณ์คุ้มครองความปลอดภัยส่วนบุคคล<br>
                        2)การให้ความช่วยเหลือผู้ประสบอันตรายจากไฟฟ้าและการปฐมพยาบาลเบื้องต้น<br>
                        3)การปฏิบัติงานเกี่ยวกับไฟฟ้าที่มีความเสี่ยงจากลักษณะงานอื่นรวมอยู่ด้วย เช่นการทำงานในที่สูง
                        การทำงานในบริเวณที่อาจเป็นอันตราย เป็นต้น
                    </div>
