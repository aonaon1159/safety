        ...
        var Editor_Editor = /*#__PURE__*/function () {
          ...
          Editor_createClass(Editor, [{
            ...
            */
            ...
            key: "insertImage",
            value: function insertImage(src, param, alt) {
              var _this3 = this;
              ...
              return createImage(src, param).then(function ($image) {
                ...
                if (typeof param === 'function') {
                  ...
                  $image.attr('alt', $('.note-image-alt').val());
        ...
        var Buttons_Buttons = /*#__PURE__*/function () {
          ...
          Buttons_createClass(Buttons, [{
            ...
            value: function addImagePopoverButtons() {
              ...
              this.context.memo('button.resize75per', function () {
                return _this3.button({
                  contents: '<span class="note-fontsize-10">75%</span>',
                  tooltip: _this3.lang.image.resize75per,
            ...
            value: function showLinkDialog(linkInfo) {
              ...
              return external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default.a.Deferred(function (deferred) {
                ...
                _this.ui.onDialogHidden(_this.$dialog, function () {
                  // detach events
                  if (($("[id^=m_]").data('bs.modal') || {})._isShown) { $("body").addClass("modal-open"); }
                  $linkText.off();
                  $linkUrl.off();
                  $linkBtn.off();
    ...
    /* text */ {
        ...
        external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default.a.summernote = external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default.a.extend(external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default.a.summernote, {
          ...
          options: {
            ...
            popatmouse: true,
            popover: {
              image: [['resize', ['resizeFull', 'resize75per', 'resizeHalf', 'resizeQuarter', 'resizeNone']], ['float', ['floatLeft', 'floatRight', 'floatNone']], ['remove', ['removeMedia']]],
            ...
            fontNames: ['Kanit','Poppins','Arial', 'Arial Black', 'Comic Sans MS', 'Courier New', 'Helvetica Neue', 'Helvetica', 'Impact', 'Lucida Grande', 'Tahoma', 'Times New Roman', 'Verdana'],
...
/***/ (function (module, __webpack_exports__, __webpack_require__) {
        ...
        var dialog = renderer["a" /* default */].create('<div class="modal fade note-modal" aria-hidden="false" tabindex="-1" role="dialog"/>', function ($node, options) {
          if (options.fade) {
            $node.addClass('fade');
          }
