...
<?php 
    $id_training = 169;//มาตรฐานการตรวจสอบระบบไฟฟ้า สำหรับ โรงงานอุตสาหกรรม
...
<main id="main-container" class="main-container">
    ...
    <section class="padding_bottom">
        <div class="container p-t-160 p-b-80 no_br">
            <h2 class="text-center"><b>มาตรฐานการตรวจสอบระบบไฟฟ้า สำหรับ โรงงานอุตสาหกรรม</b></h2>
                    ...
                    <div class="row">
                        <div class="col-lg-9 col-md-11 col-12 m-auto">
                            <h6>
                                ...
                                ช่างเทคนิคไฟฟ้า หรือ เจ้าหน้าที่ของฝ่ายวิศวกรรม
                                ซึ่งจะเป็นไปตามกฎหมายของกระทรวงอุตสาหกรรม ตามกฎกระทรวง
                                กำหนดมาตรการความปลอดภัยเกี่ยวกับระบบไฟฟฟ้าในโรงงาน พ.ศ. 2550
                                และตามกฎหมายของกระทรวงแรงงาน ตามกฎกระทรวงกำหนดมาตรฐานในการบริหาร จัดการ
                    ...
                    <div class="row">
                        <div class="col-lg-9 col-md-11 col-12 m-auto">
                            <h6>
                                ...
                                เพื่อให้ระบบไฟฟ้าสามารถใช้งานได้ยาวนาน และมีความเชื่อถือได้
    ...
    <section class="white-bg padding_top" id="table_course">
        <div class="container p-b-80 p-t-80">
            <h2 class="text-center"><b class="head_nav">มาตรฐานการตรวจสอบระบบไฟฟ้า สำหรับ โรงงานอุตสาหกรรม</b></h2>
            <hr class="hr_green mx-auto hr_fix_width">
            <h5 class="text-center">ท่านสามารถค้นหาหลักสูตรมาตรฐานการตรวจสอบระบบไฟฟ้า สำหรับ โรงงานอุตสาหกรรม
            </h5>
            <br>
            <div class="row">
                <div class="col-md-12">
                    <div class="tab" role="tabpanel">
                        <ul class="nav nav-tabs" role="tablist">
                            <li style="width: 50%;" class="text-center" role="presentation"><a data-id_branch="46"
                                    data-id_training="447" href="#tab1" class="active" role="tab" data-toggle="tab"></i>
                                    <h5>ออนไลน์</h5>
                                </a></li>
            ...
            <div class="col-lg-6 col-md-12 col-12 align-self-center black-bg p-t-80 p-b-80">
                <div class="row mx-4">
                    <div class="col-lg-12 col-md-11 col-12 m-auto">
                        ...
                        <hr class="hr_green mx-auto hr_fix_width">
                        การขับเคลือนของเครื่องจักรต่างๆ ในโรงงาน จำเป็นต้องใช้กระแสไฟฟ้าเป็นตัวขับเคลื่อน
                        ซึ่งมีความอันตรายและส่งผลรวดเร็วมาก บางครั้งเหตุการณ์ไม่คาดฝันก็สามารถกิดขึ้นได้เสมอ เช่น
                        ระบบไฟฟ้าลัดวงจร ทำให้โรงงานไฟไหม้ ระบบไฟฟ้าในโรงงานขัดข้อง ทำให้เครื่องจักรหยุดทำงาน
                        ไม่สามารถผลิตสินค้าได้
                        สร้างความเสียหายให้บริษัทอย่างมหาศาลหม้อแปลงหลักของโรงงานระเบิดทำให้การขับเคลือนของเครื่องจักรหยุดชะงัก
                        เป็นต้น ปัญหาเหล่านี้ เมือเกิดขึ้นนั้น รวดเร็วและยากที่จะแก้ไขได้ทัน
                        ซึงอาจส่งผลเสียหายต่อชีวิตและทรัพย์ในโรงงานทั้งหมด
                        โรงงานอุตสาหกรรมจะต้องมีการตรวจสอบระบบไฟฟ้าโรงงานและบำรุงรักษาระบบไฟฟ้าโรงงานประจาปีทุกๆปีเพื่อลดปัญหาที่เกิดขึ้นกับระบบไฟฟ้าภายในโรงงาน<br><br>

                        วัตถุประสงค์<br>
                        1) เพื่อให้ผู้ข้ารับการอบรมมีทักษะ ความรู้ความเข้าใจ ต่อกระบวนการตรวจสอบระบบไฟฟ้า
                        สำหรับโรงงานอุดสาหกรรมตามมาตรฐาน<br>
                        2) เพื่อให้ผู้เข้ารับการอบรมเรียนรู้ กระบวนการตรวจสอบระบบไฟฟ้า สำหรับ
                        โรงงานอุตสาหกรรมตามมาตรฐาน<br><br>

                        ผลที่คาดว่าจะได้รับ<br>
                        1) ผู้เข้ารับการอบรมสามารถเรียนรู้ กระบวนการตรวจสอบระบบไฟฟ้า
                        สำหรับโรงงานอุตสาหกรรมตามมาตรฐาน<br>
                        2) ผู้เข้ารับการอบรมสามารถนำความรู้ไปใช้ กระบวนการตรวจสอบระบบไฟฟ้า
                        สำหรับโรงงานอุตสาหกรรมตามมาตรฐาน<br><br>

                        รูปแบบการฝึกอบรม<br>
                        1) เน้นการเรียนรู้แบบบูรณาการ (Theory and experience)<br>
                        2) เน้นการแลกเปลี่ยนเรียนรู้แบบการสาธิตและตัวอย่าง (Demonstration)<br>
                        3) เน้นการเรียนรู้แบบ Action Leaning การฝึกปฏิบัติการตรวจสอบระบบไฟฟ้า
                    </div>
    ...
    <section>
        <div class="container_small p-t-80 p-b-80">
            <h2 class="text-center"><b>
                    มาตรฐานการตรวจสอบระบบไฟฟ้า สำหรับ โรงงานอุตสาหกรรม
                </b></h2>
            <hr class="hr_green mx-auto hr_fix_width">
            <br>
            <div class="row mx-auto">
                <div class="col-md-4 col-12 offset-md-2 mb-4 p-4 text-right article_course">
                    <img title="" class="img-fluid box_shadow"
                        src="<?php echo $base_url;?>/img/template_article/บทความตรวจสอบไฟฟ้า-01.jpg" alt="">
                </div>
                <div class="col-md-4 col-12 mb-4 p-4 text-left article_course">
                    <img title="" class="img-fluid box_shadow"
                        src="<?php echo $base_url;?>/img/template_article/บทความตรวจสอบไฟฟ้า-02.jpg" alt="">
                </div>
                <div class="col-md-4 col-12 mb-4 offset-md-2 px-4 text-right article_course">
                    <img title="" class="img-fluid box_shadow"
                        src="<?php echo $base_url;?>/img/template_article/บทความตรวจสอบไฟฟ้า-03.jpg" alt="">
                </div>
                <div class="col-md-4 col-12 mb-4 px-4 text-left article_course">
                    <img title="" class="img-fluid box_shadow"
                        src="<?php echo $base_url;?>/img/template_article/บทความตรวจสอบไฟฟ้า-04.jpg" alt="">
                </div>
            </div>
            <div class="row">
            ...
            <div class="row information">
                ...
                <div class="col-md-6 col-12 my-3">
                    <button type="button" class="btn btn-block btn--medium p-3 btn_collap collapsed"
                        ...
                        <div class="d-flex justify-content-between align-items-center head_collap">
                            <h5><b>ประเภทของแรงดันไฟฟ้า</b></h5>
                            <i class="fas fa-plus"></i>
                        </div>
                        <div id="collap8" class="collapse detail_collapse">
                            (1) ไฟฟ้าแรงสูง<br>
                            เมื่อพูดถึงไฟฟ้าแรงสูง ทุกคนอาจจะติดว่ามันคงเป็นไฟฟ้าเหมือนกันวิ่งตามสายไฟมาเหมือนกัน
                            แต่จริงๆ แล้วไฟฟ้าแรงสูงนั้นมีค่าแรงดันไฟฟ้าสูงกว่าไฟฟ้าตามบ้านเป็นอย่างมาก
                            และผ่านการแปลงด้วยหล้อแปลงไฟฟ้าตามจุดต่างๆ จนลดลงเหลือ 220V ที่ใช้งานตามบ้านทั่วไป
                            การส่งไฟฟ้ามาในระยะทางไกลๆ จากโรงไฟฟ้า เป็นร้อยๆ กิโลเมตร
                            จำเป็นจะต้องส่งไฟฟ้าที่มีแรงดันสูงออกมา เพราะไฟฟ้าที่มีแรงดันมากๆ
                            จะสามารถเดินทางไปในระยะทางที่ไกลและลดการสูญเสียไฟฟ้าได้ดีกว่า
                            ไฟฟ้าแรงสูงจะมีอยู่หลายระดับแรงดันไฟฟ้า ตามรายละเอียดจากการไฟฟ้าฝ่ายผลิตแห่งประเทศไทย
                            มีดังนี้<br>
                            500 กิโลโวลต์ (500KV)<br>
                            230 กิโลโวลต์ (230KV)<br>
                            115 กิโลโวลต์ (115KV)<br>
                            69 กิโลโวลต์ (69KV)<br>
                            ซึ่งจุดสังเกตคือยิ่งเสาที่มีขนาดสูงมากก็ยิ่งเป็นเสาไฟฟ้าที่มีแรงดันไฟฟ้ายิ่งมาก
                            และสายไฟฟ้าบนเสา ก็ไม่ควรไปเข้าใกล้อย่างมาก เพราะเป็นอันตราย โดยควรอยู่ห่างจากสายอย่างน้อย 4
                            เมตร<br>

                            (2) ไฟฟ้า 3 เฟส (ไฟฟ้าโรงงาน)<br>
                            ระบบไฟฟ้า 3 เฟส จะมีสายไฟในระบบถึง 4 เส้น ซึ่งสายไลน์กับไลน์ในจะมีแรงดังไฟฟ้า 380-400 V
                            และสายไลน์กับสายนิวทรอลมีแรงดันไฟฟ้า 220-230V มีความถี่ที่ 50Hz และสายนิวทรอลที่ไม่มีไฟอีก 1
                            เส้น<br>

                            ซึ่งระบบไฟฟ้า 3 เฟานี้ จะเหมาะสำหรับอุปกรณ์ไฟฟ้าสำหรับโรงงาน
                            ที่ใช้กับเครื่องจักรอุตสาหกรรมโรงงาน เพราะเครื่องจักรเหล่านี้ใช้แรงดันไฟฟ้าสูงกว่าปกติ
                            และมีการเปิดการใช้งานแบบต่อเนื่อง พร้อมๆ กัน<br>

                            ระบบไฟฟ้า 3 เฟส ก็สามารถติดตั้งภายในบ้านได้ แต่จะต้องแบ่งใช้ไฟฟ้า เป็น 3 ชุด ชุดละ 1 เฟส
                            กระจายไปตามจุดต่างๆ ภายในบ้าน ทำให้สามารถใช้งานภายในบ้านได้ แต่การขอใช้งานไฟฟ้า 3 เฟส
                            จะมีขั้นตอนค่อนข้าง เยอะ และมีค่าใช้จ่ายสูงกว่า ระบบไฟฟ้า 1 เฟส<br>

                            (3) ไฟฟ้า 1 เฟส (ไฟฟ้าตามบ้านเรือนทั่วไป)<br>
                            ระบบไฟฟ้า 1 เฟส จะให้แรงดันไฟฟ้า 220-230V มีความถี่ที่ 50Hz โดยจะมีสายไฟอยู่ 2 เส้น
                            คือสายเฟสหรือสายไฟ และสายนิวทรอล ซึ่งการใช้งาน เราจะต้องเสียบให้ครบทั้ง 2 ช่อง
                            และสายไฟที่ใช้งาน 2 เส้น ถึงจะใช้งานได้<br>

                            การติดตั้งระบบไฟฟ้า 1 เฟส สามารถขอติดตั้งได้ง่าย และมีค่าใช้จ่ายไม่แพงนัก
                            จึงเป็นที่นิยมในการติดตั้งภายในบ้านเรือนทั่วไป
                        </div>
                    </button>
                </div>
