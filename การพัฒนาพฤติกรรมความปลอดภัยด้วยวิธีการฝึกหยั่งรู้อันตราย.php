...
<?php 
    $id_training = 421;//การพัฒนาพฤติกรรมความปลอดภัยด้วยวิธีการฝึกหยั่งรู้อันตราย (KYT)
...
<main id="main-container" class="main-container">
    ...
    <section class="padding_bottom">
        <div class="container p-t-160 p-b-80 no_br">
            <h2 class="text-center"><b>การพัฒนาพฤติกรรมความปลอดภัยด้วยวิธีการฝึกหยั่งรู้อันตราย (KYT)</b></h2>
    ...
    <section class="white-bg padding_top" id="table_course">
        <div class="container p-b-80 p-t-80">
            <h2 class="text-center"><b class="head_nav">การพัฒนาพฤติกรรมความปลอดภัยด้วยวิธีการฝึกหยั่งรู้อันตราย
                    (KYT)</b></h2>
            <hr class="hr_green mx-auto hr_fix_width">
            <h5 class="text-center">ท่านสามารถค้นหาหลักสูตรการพัฒนาพฤติกรรมความปลอดภัยด้วยวิธีการฝึกหยั่งรู้อันตราย
                (KYT)
            </h5>
            <br>
            <div class="row">
                    ...
                    <div class="tab" role="tabpanel">
                        <ul class="nav nav-tabs" role="tablist">
                            <li style="width: 50%;" class="text-center" role="presentation"><a data-id_branch="46"
                                    data-id_training="568" href="#tab1" class="active" role="tab" data-toggle="tab"></i>
                                    <h5>ออนไลน์</h5>
                                </a></li>
            ...
            <div class="col-lg-6 col-md-12 col-12 align-self-center black-bg p-t-80 p-b-80">
                <div class="row mx-4">
                    <div class="col-lg-12 col-md-11 col-12 m-auto">
                        ...
                        โดยเฉพาะพฤติกรรมการทำงานที่เสี่ยง
                        ไม่ปลอดภัยของพนักงาน เช่น เผอเรอ เหม่อลอย ลัดขั้นตอน รีบเร่ง
                        อันเป็นเหตุของการผิดพลาดและเกิดการสูญเสียในการทำงานทั้งสิ้น
                        หากพนักงานมีการฝึกหยั่งรู้ระวังภัย (อันตรายล่วงหน้า)
                        อาจทำให้การปฏิบัติงานปราศจากอุบัติเหตุจากการทำงาน
                        (Kiken Yoshi Training : KYT) เป็นอีกหนึ่งเทคนิคที่สามารถลดการเกิดอุบัติเหตุ
                        การได้รับบาดเจ็บได้เป็นอย่างดี
                        และช่วยส่งผลต่อการสร้างวัฒนธรรมความปลอดภัยในองค์กร กิจกรรม
                        KYTเน้นหลักการคิดและวิเคราะห์อันตรายหรือการประเมิน
                        ความเสี่ยงส่งเสริมพฤติกรรมที่นำไปสู่ความปลอดภัย<br><br>
    ...
    <section>
        <div class="container_small p-t-80 p-b-80">
            <h2 class="text-center"><b>
                    การพัฒนาพฤติกรรมความปลอดภัยด้วยวิธีการฝึกหยั่งรู้อันตราย
                </b></h2>
            <hr class="hr_green mx-auto hr_fix_width">
            <br>
        ...
        <div class="container p-b-80 p-t-80 no_br">
            <div class="row">
                ...
                <div class="col-md-6 col-12 align-self-center mb-3">
                    <div class="row">
                        <div class="col-lg-9 col-md-11 col-12 m-auto">
                            <h4><b>การพัฒนาพฤติกรรมความปลอดภัยด้วยวิธีการฝึกหยั่งรู้อันตราย (KYT) | เซฟตี้อินไทย</b>
                            </h4>
            ...
            <div class="row">
                <div class="col-lg-6 align-self-center text-center mb-3">
                    <img title="" class="box_shadow img-fluid"
                        src="<?php echo $base_url;?>/img/bg/KYT ฝึกหยั่งรู้ระวังภัย (อันตรายล่วงหน้า)-ชลบุรี-ระยอง-สมุทรปราการ-เซฟตี้อินไทย-safetyinthai.jpg"
                        alt="">
                </div>
                <div class="col-lg-6 px-5 align-self-center mb-3">
                    <h2 class="text-center"><b>KYT ฝึกหยั่งรู้ระวังภัย (อันตรายล่วงหน้า)</b></br></h2>
                    <hr class="hr_green mx-auto hr_fix_width">
                    <div class="about__Text">
                        <p>
                            จุดเริ่มต้นของอุบัติเหตุในการทำงาน HUMAN ERROR จะต้องแก้ไขอย่างไร?
                            โดยเฉพาะพฤติกรรมการทำงานที่เสี่ยง ไม่ปลอดภัยของพนักงาน เช่น เผอเรอ เหม่อลอย ลัดขั้นตอน
                            รีบเร่ง อันเป็นเหตุของการผิดพลาดและเกิดการสูญเสียในการทำงานทั้งสิ้น
                            หากพนักงานมีการฝึกหยั่งรู้ระวังภัย (อันตรายล่วงหน้า)
                            อาจทำให้การปฏิบัติงานปราศจากอุบัติเหตุจากการทำงาน (Kiken Yoshi Training : KYT)
                            ...
                            เน้นหลักการคิดและวิเคราะห์อันตรายหรือการประเมินความเสี่ยงส่งเสริมพฤติกรรมที่นำไปสู่ความปลอดภัย
                        </p>
                    </div>
                    <br>
                    <div class="row">
                        <div class="col-md-6 col-8">
                            <a href="kytฝึกหยั่งรู้ระวังภัย">
                                <button
                                    class="btn btn-block btn--medium btn--radius btn--black btn--black-hover-green font--light text-uppercase">
                                    รายละเอียดเพิ่มเติม
                                </button>
                    ...
                    <ul>
                        <li><i class="fas fa-check-circle"></i>
                            เพื่อให้ผู้อบรมมีความรู้เข้าใจ หลักการ
                            ความสำคัญและตระหนักถึงความปลอดภัยในการทำงานสร้างจิตสำนึกในความปลอดภัย
                        </li>
                        <li><i class="fas fa-check-circle"></i>
                            เพื่อให้ผู้อบรมเข้าใจหลักการวิเคราะห์และสื่อสารด้วยข้อความสั้นๆ พร้อมทั้งสร้างเทคนิคการทำ
                            KYT แบบต่างๆ ไปประยุกต์ใช้เพื่อให้เกิดความปลอดภัยในการทำงานและเกิดความปลอดภัยชีวิตประจำวัน
                        </li>
                        <li><i class="fas fa-check-circle"></i>
                            เพื่อให้ผู้อบรมสร้างวัฒนธรรมความปลอดภัยและจิตสำนึกที่ดีอันเป็นหัวใจหลักของการวางรากฐานของพฤติกรรมความปลอดภัย
                        </li>
                    </ul>
                </div>
            </div>
