...
<?php 
    $id_training = 168;//การออกแบบระบบไฟฟ้าและข้อกำหนดการติดตั้งตามมาตรฐานการติดตั้งทางไฟฟ้าสากล
...
<main id="main-container" class="main-container">
    ...
    <section class="padding_bottom">
        <div class="container p-t-160 p-b-80 no_br">
            <h2 class="text-center"><b>การออกแบบระบบไฟฟ้าและข้อกำหนดการติดตั้งตามมาตรฐานการติดตั้งทางไฟฟ้าสากล</b></h2>
                ...
                <div class="col-md-6 col-12 align-self-center mb-3">
                    <div class="row">
                        <div class="col-lg-9 col-md-11 col-12 m-auto">
                            <h6>
                                มาตรฐานสากลเกี่ยวกับไฟฟ้าที่พบได้บ่อย คือ IEC (International Electrotechnical
                                Commission) เป็นมาตรฐานด้านไฟฟ้าและอิเล็กทรอนิกส์ที่องค์การระหว่างประเทศร่างขึ้น
                                ในปัจจุบันมีประเทศสมาชิกเกือบทั่วโลกรวมถึงประเทศไทยด้วย
                            </h6>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-md-6 col-12 align-self-center mb-3">
                    <div class="row">
                        <div class="col-lg-9 col-md-11 col-12 m-auto">
                            <h6>
                                ปัจจุบันมีการปรับปรุงมาตรฐานประจำชาติให้สอดคล้องกับมาตรฐานสากล
                                บางประเทศได้ยกเลิกมาตรฐานประจำชาติและเปลี่ยนมาใช้มาตรฐานสากล
                                เพียงอย่างเดียว
                            </h6>
                        </div>
                    </div>
    ...
    <section class="white-bg padding_top" id="table_course">
        <div class="container p-b-80 p-t-80">
            <h2 class="text-center"><b
                    class="head_nav">การออกแบบระบบไฟฟ้าและข้อกำหนดการติดตั้งตามมาตรฐานการติดตั้งทางไฟฟ้าสากล</b></h2>
            <hr class="hr_green mx-auto hr_fix_width">
                    ...
                    <div class="tab" role="tabpanel">
                        <ul class="nav nav-tabs" role="tablist">
                            <li style="width: 50%;" class="text-center" role="presentation"><a data-id_branch="46"
                                    data-id_training="01" href="#tab1" class="active" role="tab" data-toggle="tab"></i>
                                    <h5>ออนไลน์</h5>
                                </a></li>
            ...
            <div class="col-lg-6 col-md-12 col-12 align-self-center black-bg p-t-80 p-b-80">
                <div class="row mx-4">
                    <div class="col-lg-12 col-md-11 col-12 m-auto">
                        ...
                        <hr class="hr_green mx-auto hr_fix_width">
                        หลักสูตรการออกแบบระบบไฟฟ้และข้อกำหนดการติดตั้งตามมาตร ฐานการดิดตั้งทางไฟฟ้าสากลมี
                        เนื้อหาเกี่ยวกับการออกแบบวงจรย่อย วงจรสายป้อน วงจรประธาน การออกแบบวงจรมอเตอร์ การทำ Load
                        Schedule Feeder Schedule ที่ถูกต้อง การคำนวณกระแสถัดวงจร เพื่อหาพิกัดของเซอร์กิดเบรกเกอร์ การทำ
                        Protection และ Co-ordination เครื่องกำเนิดไฟฟ้าสำรอง และการปรับปรุงตัวประกอบกำลัง การออกแบบระบบ
                        ไฟฟ้โรงงานอุตสาหกรรมที่สมบูรณ์
                        เหมาะสำหรับใช้ป็นตำราเรียนหรืออ้างอิงในวิชาการออกแบบระบบไฟฟ้า<br><br>

                        วัตถุประสงค์<br>
                        1) เพื่อให้ผู้เข้ารับการอบรมมีทักษะ ความรู้ความเข้าใจ การออกแบบระบบไฟฟ้าและข้อกำหนดการติดตั้ง
                        ตามมาตรฐานการติดตั้งทางไฟฟ้าสากล<br>
                        2) เพื่อให้ผู้เข้ารับการอบรมเรียนรู้วัตถุประสงค์ กระบวนการในการการออกแบบระบบไฟฟ้และ
                        ข้อกำหนดการติดตั้งตามมาตรฐานการติดตั้งทางไฟฟ้าสากล<br><br>

                        ผลที่คาดว่าจะได้รับ<br>
                        1) ผู้ข้ารับการอบรมสามารถการออกแบบระบบไฟฟ้และข้อกำหนดการติดตั้ง
                        ได้อย่างมีมาตรฐานและความปลอดภัย<br>
                        2) ผู้เข้ารับการอบรมสามารถนำความรู้ไปใช้ในการทำงานได้อย่างมีประสิทธิภาพ<br><br>

                        รูปแบบการฝึกอบรม<br>
                        1) เนั้นการเรียนรู้แบบบูรณาการ (Theory and experience)<br>
                        2) เน้นการแลกเปลี่ยนเรียนรู้แบบการสาธิตและตัวอย่าง (Demonstration)<br>
                        3) เน้นกระบวนการเรียนรู้ผ่านสื่อ (Technology-based leamning )<br>
            ...
            <div class="row mx-auto">
                <div class="col-md-4 col-12 offset-md-2 mb-4 p-4 text-right article_course">
                    <img title="" class="img-fluid box_shadow"
                        src="<?php echo $base_url;?>/img/template_article/บทความการติดตั้งทางไฟฟ้าสากล-01.jpg" alt="">
                </div>
                <div class="col-md-4 col-12 mb-4 p-4 text-left article_course">
                    <img title="" class="img-fluid box_shadow"
                        src="<?php echo $base_url;?>/img/template_article/บทความการติดตั้งทางไฟฟ้าสากล-02.jpg" alt="">
                </div>
                <div class="col-md-4 col-12 mb-4 offset-md-2 px-4 text-right article_course">
                    <img title="" class="img-fluid box_shadow"
                        src="<?php echo $base_url;?>/img/template_article/บทความการติดตั้งทางไฟฟ้าสากล-03.jpg" alt="">
                </div>
                <div class="col-md-4 col-12 mb-4 px-4 text-left article_course">
                    <img title="" class="img-fluid box_shadow"
                        src="<?php echo $base_url;?>/img/template_article/บทความการติดตั้งทางไฟฟ้าสากล-04.jpg" alt="">
                </div>
            </div>
            <div class="row">
            ...
            <div class="row information">
                ...
                <div class="col-md-6 col-12 my-3">
                    <button type="button" class="btn btn-block btn--medium p-3 btn_collap collapsed"
                        ...
                        <div class="d-flex justify-content-between align-items-center head_collap">
                            <h5><b>เครื่องใช้ไฟฟ้าใดบ้างที่ต้องมีสายดิน</b></h5><i class="fas fa-plus"></i>
                        </div>
